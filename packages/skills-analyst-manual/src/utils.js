...
// Manifest
const MANIFEST_FILE = '.skills-analyst-manual.json';
...
// Components — Analyst Manual specific
const COMPONENTS = {
  skill_analyst: {
    src: '.claude/skills/analyst-manual-full',
    label: 'Analyst Manual Full Skill (orchestrator)',
    group: 'core',
  },
  skill_explore: {
  ...
  commands: {
    src: '.claude/commands',
    label: 'Analyst Manual Command (1 command)',
    group: 'core',
    filter: 'analyst-manual',
  },
};
