 ...
 */
export declare const SCOUT_VERSION = "0.1.0";
export type { GitHubSearchItem, IntelligenceReport, Recommendation, RepoProfile, ScanOptions, ScanResult, SkillFormat, } from './types.js';
...
export type { Discovery, DiscoveryKind, DiscoveryVerdict, RepositoryDiscovery, ReleaseDiscovery, CommitDiscovery, PublicationDiscovery, PostDiscovery, } from './discovery.js';
...
export { DIFF_BUCKETS, OVERLAP_MS, ConcurrentRunError, advanceWatermark, applyOutcomes, commitRun, diffDiscoveries, emptyWatermarkState, readCommittedRun, watermarkKey, withRunLock, } from './source-watermark.js';
export type { CommittedRun, DiffBucket, DiscoveryDiff, ObservedItem, SourceRunOutcome, SourceWatermark, WatermarkState, } from './source-watermark.js';
...
export { createRateLimitState, getDelay, markRetry, markSuccess, shouldRetry, updateFromHeaders, } from './rate-limiter.js';
