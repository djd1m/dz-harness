...
| Stable | Stable | Used in 3+ projects. Proven track record. Passed a BTO evaluation (separate package: `@dzhechkov/skills-bto`) or equivalent. | 🟢 |
...
- At least one of the following validation signals exists:
  - Passed a BTO Layer 2 evaluation (separate package: `@dzhechkov/skills-bto`) with score >= 7.0.
...
- A BTO evaluation run (separate package: `@dzhechkov/skills-bto`) scores the finding below 5.0.
