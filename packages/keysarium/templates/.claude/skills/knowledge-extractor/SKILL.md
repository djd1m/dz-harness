...
bto_score: 7.5
bto_date: "2026-03-03"
trust_tier_path: "Run a BTO evaluation from the separate package @dzhechkov/skills-bto, score >= 8.5 + eval tests for Tier 3"
---
...
| BTO | Post-harvest | Placed skills can be evaluated with the separate package `npx @dzhechkov/skills-bto` |
