...
const AGENTS_MD_PREAMBLE = 'This file gives AI coding agents shared, always-on context for this repo. ' +
...
const GEMINI_MD_PREAMBLE = 'This file gives the Gemini CLI / Code Assist shared, always-on context for this repo. ' +
    'The section below is managed by dz — edit your own notes outside the fenced block.';
/**
 ...
 */
export function renderAgentsMdSection(skill) {
...
function buildManagedBlock(sections, beginMarker, endMarker) {
 ...
 */
function mergeManagedMarkdown(existing, sections, identity) {
 ...
 */
export function mergeAgentsMd(existing, sections) {
 ...
 */
export function mergePolicyBlock(existing, sections) {
    return mergeManagedMarkdown(existing, sections, {
        title: 'AGENTS.md',
        preamble: AGENTS_MD_PREAMBLE,
 ...
 */
export function mergeGeminiMd(existing, sections) {
    return mergeManagedMarkdown(existing, sections, {
        title: 'GEMINI.md',
