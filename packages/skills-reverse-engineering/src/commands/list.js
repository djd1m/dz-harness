...
async function run(options) {
  ...
  if (!fileExists(manifestPath)) {
    warn('Reverse Engineering Unicorn skill pack is not installed in this directory.');
  ...
  // ── Header ────────────────────────────────────────────────────────────
  console.log('');
  console.log(bold(`@dzhechkov/skills-reverse-engineering v${manifest.version}`));
