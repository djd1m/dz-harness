...
// Manifest
const MANIFEST_FILE = '.skills-reverse-engineering.json';
...
// Components — Reverse Engineering Unicorn specific
const COMPONENTS = {
  skill_reverse: {
    src: '.claude/skills/reverse-engineering-unicorn',
    label: 'Reverse Engineering Unicorn Skill (orchestrator)',
    group: 'core',
  },
  skill_explore: {
  ...
  skill_goap: {
    src: '.claude/skills/goap-research-ed25519',
    label: 'GOAP Research + Ed25519 Skill (verified research)',
    group: 'deps',
  },
  skill_solver: {
    src: '.claude/skills/problem-solver-enhanced',
    label: 'Problem Solver Enhanced Skill (TRIZ + Game Theory)',
    group: 'deps',
  },
  commands: {
    src: '.claude/commands',
    label: 'Reverse Engineering Unicorn Command (1 command)',
    group: 'core',
    filter: 'reverse-engineering-unicorn',
  },
};
