---
name: health-advisor-clinical-diagnostic-reasoning
...
Clinical Diagnostic Reasoning is a pure-prompt skill that helps clinicians identify and counteract cognitive biases in medical decision-making. It provides structured diagnostic reasoning flows, case-based error analysis frameworks, and patient communication guidance to improve diagnostic accuracy and reduce systematic thinking errors in clinical practice.
...
Identify equivalent framings:
    ...
    - Absolute numbers
    - Relative risk WITH its absolute counterpart (or an explicit unknown baseline) —
      a ratio is not a risk, and "21x higher" is 1 excess case per 1394 people
    ↓
...
None. This is a pure prompt skill with no external tool, API, or skill dependencies. It uses only the Read tool for accessing patient case files when provided.
