...
class LabResultsCoworker:
    ...
    def _load_reference_ranges(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            # Thyroid
            "TSH": {"low": 0.27, "high": 4.2, "unit": "mIU/L", "critical_low": 0.01, "critical_high": 100},
            "Free T4": {"low": 0.8, "high": 1.8, "unit": "ng/dL", "critical_low": None, "critical_high": None},
            "Free T4 (pmol/L)": {"low": 12, "high": 22, "unit": "pmol/L", "critical_low": None, "critical_high": None},
            ...
            # Muscle / Tissue
            "CPK": {"low": 39, "high": 308, "unit": "U/L", "critical_low": None, "critical_high": 1000,
                     "male": {"low": 39, "high": 308}, "female": {"low": 26, "high": 192}},
            "CK": {"low": 39, "high": 308, "unit": "U/L", "critical_low": None, "critical_high": 1000,
                    "male": {"low": 39, "high": 308}, "female": {"low": 26, "high": 192}},

            # Vitamin D
            "Vitamin D": {"low": 30, "high": 100, "unit": "ng/mL", "critical_low": 10, "critical_high": None},
            "25-OH Vitamin D": {"low": 30, "high": 100, "unit": "ng/mL", "critical_low": 10, "critical_high": None},
            "Vitamin D (25-OH)": {"low": 30, "high": 100, "unit": "ng/mL", "critical_low": 10, "critical_high": None},

            # Hormones — Testosterone
            "Total Testosterone": {"low": 8.64, "high": 29.0, "unit": "nmol/L", "critical_low": None, "critical_high": None,
                                   "male": {"low": 8.64, "high": 29.0}, "female": {"low": 0.29, "high": 1.67}},
            "Testosterone": {"low": 8.64, "high": 29.0, "unit": "nmol/L", "critical_low": None, "critical_high": None,
                             "male": {"low": 8.64, "high": 29.0}, "female": {"low": 0.29, "high": 1.67}},
            "Free Testosterone": {"low": 0.174, "high": 0.672, "unit": "nmol/L", "critical_low": None, "critical_high": None},

            # Insulin Resistance
            "HOMA-IR": {"low": 0, "high": 2.5, "unit": "", "critical_low": None, "critical_high": None},
            "Insulin": {"low": 2.6, "high": 24.9, "unit": "μIU/mL", "critical_low": None, "critical_high": None},
            "Fasting Insulin": {"low": 2.6, "high": 24.9, "unit": "μIU/mL", "critical_low": None, "critical_high": None},

            # Liver — GGT
            "GGT": {"low": 10, "high": 71, "unit": "U/L", "critical_low": None, "critical_high": None,
                     "male": {"low": 10, "high": 71}, "female": {"low": 6, "high": 42}},

            # Uric Acid
            "Uric Acid": {"low": 202, "high": 416, "unit": "μmol/L", "critical_low": None, "critical_high": None,
                          "male": {"low": 202, "high": 416}, "female": {"low": 143, "high": 339}},

            # Iron Studies
            "Ferritin": {"low": 30, "high": 400, "unit": "ng/mL", "critical_low": None, "critical_high": None,
                         "male": {"low": 30, "high": 400}, "female": {"low": 13, "high": 150}},
        }
    ...
    def _load_clinical_context(self) -> Dict[str, Dict[str, str]]:
        ...
        return {
            ...
            "CPK": {
                "high": "May indicate muscle damage, strenuous exercise, or rhabdomyolysis if very high",
                "low": "Usually not clinically significant; may reflect low muscle mass",
                "description": "Enzyme released when muscle tissue is damaged (also called CK)",
            },
            "CK": {
                "high": "May indicate muscle damage, strenuous exercise, or rhabdomyolysis if very high",
                "low": "Usually not clinically significant; may reflect low muscle mass",
                "description": "Enzyme released when muscle tissue is damaged (also called CPK)",
            },
            "Vitamin D": {
                "high": "Possible toxicity if very high; may cause hypercalcemia",
                "low": "Deficiency associated with bone loss, fatigue, and immune dysfunction; <20 ng/mL is deficient, 20-29 is insufficient",
            ...
            "Total Testosterone": {
                "high": "May be associated with PCOS in females; evaluate clinical context",
                "low": "May cause fatigue, low libido, reduced muscle mass; <12 nmol/L in males is low-normal and warrants evaluation",
                "description": "Primary male sex hormone; important for muscle, bone, and reproductive health",
            },
            "Testosterone": {
                "high": "May be associated with PCOS in females; evaluate clinical context",
                "low": "May cause fatigue, low libido, reduced muscle mass; <12 nmol/L in males is low-normal and warrants evaluation",
            ...
            "Free Testosterone": {
                "high": "May indicate excess androgen activity",
                "low": "May contribute to fatigue, low libido, and reduced muscle mass",
                "description": "Unbound, biologically active fraction of testosterone",
            },
            "HOMA-IR": {
                "high": "Values 2.5-5.0 suggest insulin resistance; >5.0 indicates significant insulin resistance",
                "low": "Normal insulin sensitivity",
                "description": "Index estimating insulin resistance from fasting glucose and insulin",
            },
            "Insulin": {
                "high": "May indicate insulin resistance, metabolic syndrome, or insulinoma",
                "low": "May indicate type 1 diabetes or insulin-deficient state",
                "description": "Hormone that regulates blood sugar; measured fasting for best accuracy",
            },
            "Fasting Insulin": {
                "high": "May indicate insulin resistance, metabolic syndrome, or insulinoma",
                "low": "May indicate type 1 diabetes or insulin-deficient state",
                "description": "Hormone that regulates blood sugar; measured in fasting state",
            },
            "GGT": {
                "high": "May indicate liver disease, bile duct obstruction, or alcohol use",
                "low": "Usually not clinically significant",
                "description": "Liver enzyme; elevated in liver and bile duct conditions",
            },
            "Uric Acid": {
                "high": "Associated with gout risk, kidney stones, and cardiovascular disease",
                "low": "May be seen in certain genetic conditions or low-purine diets",
                "description": "Waste product from purine metabolism; elevated levels can form crystals in joints",
            },
            "Ferritin": {
                "high": "May indicate iron overload, inflammation, liver disease, or hemochromatosis",
                "low": "Indicates depleted iron stores; most specific marker for iron deficiency",
                "description": "Protein that stores iron; reflects total body iron reserves",
            },
            "Free T4": {
                "high": "May indicate hyperthyroidism or excess thyroid hormone replacement",
                "low": "May indicate hypothyroidism",
                "description": "Active thyroid hormone; helps assess thyroid function alongside TSH",
            },
        }
    ...
    def _evaluate_single_result(
        ...
        If patient_context contains a 'sex' field ('male' or 'female') and
        the test has sex-specific ranges (e.g. CPK, Hemoglobin, Hematocrit,
        RBC, Testosterone, Ferritin, GGT, Uric Acid), the appropriate
        sex-specific low/high values are used.  Otherwise the default
        (wider) range is applied.
        """
        ...
        # Resolve sex-specific reference ranges when available
        ref_low = ranges.get("low", float("-inf"))
        ref_high = ranges.get("high", float("inf"))

        if patient_context and patient_context.get("sex"):
            sex = patient_context["sex"].lower()
            if sex in ("male", "female") and sex in ranges:
                sex_ranges = ranges[sex]
                ref_low = sex_ranges.get("low", ref_low)
                ref_high = sex_ranges.get("high", ref_high)
    ...
    def _identify_patterns(self, interpretations: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        tg = next((i for i in interpretations if i["test_name"] == "Triglycerides"), None)
        hdl = next((i for i in interpretations if i["test_name"] == "HDL"), None)
        homa = next((i for i in interpretations if i["test_name"] == "HOMA-IR"), None)
        met_syn_markers = []
        if tg and tg["status"] == "high":
            met_syn_markers.append("Triglycerides")
        if hdl and hdl["status"] == "low":
            met_syn_markers.append("HDL")
        if (glucose and glucose["status"] == "high") or (a1c and a1c["status"] == "high"):
            met_syn_markers.append("Glucose/HbA1c")
        if homa and homa["status"] == "high":
            met_syn_markers.append("HOMA-IR")
        if len(met_syn_markers) >= 3:
            findings.append({
                "pattern": "Metabolic syndrome indicators",
                "supporting_results": met_syn_markers,
                "recommendation": "Multiple metabolic risk factors present; discuss comprehensive metabolic evaluation with your doctor",
            })

        # Check for Vitamin D deficiency pattern
        vit_d = next((i for i in interpretations if i["test_name"] in ["Vitamin D", "25-OH Vitamin D", "Vitamin D (25-OH)"]), None)
        if vit_d and vit_d["status"] in ["low", "critical_low"]:
            findings.append({
                "pattern": "Vitamin D deficiency",
                "supporting_results": [vit_d["test_name"]],
                "recommendation": "Discuss Vitamin D supplementation and bone health evaluation with your doctor",
            })

        # Check for hormonal pattern (low testosterone + high insulin)
        testo = next((i for i in interpretations if i["test_name"] in ["Testosterone", "Total Testosterone"]), None)
        insulin = next((i for i in interpretations if i["test_name"] in ["Insulin", "Fasting Insulin"]), None)
        if testo and testo["status"] == "low" and (
            (insulin and insulin["status"] == "high") or (homa and homa["status"] == "high")
        ):
            findings.append({
                "pattern": "Hormonal-metabolic pattern",
                "supporting_results": [testo["test_name"], insulin["test_name"] if insulin else "HOMA-IR"],
                "recommendation": "Low testosterone with insulin resistance may be interrelated; consider endocrine evaluation",
            })
