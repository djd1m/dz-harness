...
├── README.md                    # This file
│
│   (references moved to ../clinical-decision-support-archive/references/
│    to reduce skill directory size — see that directory for:
│    patient_cohort_analysis.md, treatment_recommendations.md,
│    clinical_decision_algorithms.md, biomarker_classification.md,
│    outcome_analysis.md, evidence_synthesis.md)
│
├── assets/                      # Templates and examples
│   ├── templates.tex            # All LaTeX templates consolidated (color schemes,
│   │                            #   biomarker report, clinical pathway, cohort
