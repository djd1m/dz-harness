...
// Manifest
const MANIFEST_FILE = '.skills-idea2prd.json';
...
// Components — Idea2PRD Manual specific
const COMPONENTS = {
  skill_idea2prd: {
    src: '.claude/skills/idea2prd-manual',
    label: 'Idea2PRD Manual Skill (orchestrator)',
    group: 'core',
  },
  skill_explore: {
  ...
  commands: {
    src: '.claude/commands',
    label: 'Idea2PRD Manual Command (1 command)',
    group: 'core',
    filter: 'idea2prd-manual',
  },
};
