...
/**
 * `@dzhechkov/skills-transcript-site list` — Show installed components.
 *
...
async function run(options) {
  ...
  if (!fileExists(manifestPath)) {
    warn('Transcript Site skill pack is not installed in this directory.');
  ...
  // ── Header ─────────────────────────────────────────────────────────────
  console.log('');
  console.log(bold(`@dzhechkov/skills-transcript-site v${manifest.version}`));
