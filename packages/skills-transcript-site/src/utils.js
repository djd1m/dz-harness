...
// ===========================================================================
// Manifest — .skills-transcript-site.json management
// ===========================================================================

const MANIFEST_FILE = '.skills-transcript-site.json';
...
// ===========================================================================
// Component definitions — Transcript Site specific
//
// The transcript-site-generator skill is the only component.
// It lives in .claude/skills/transcript-site-generator/ (entire directory).
// ===========================================================================

const COMPONENTS = {
  skill: {
    src: '.claude/skills/transcript-site-generator',
    label: 'Transcript Site Skill (6 modules)',
    group: 'core',
  },
};
