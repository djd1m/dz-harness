...
function instructionFile(skill) {
...
export const copilotAdapter = {
    ...
    compile(skill, ctx) {
        ...
        const scriptsNote = skill.assets.length > 0 ? ' scripts/ and other assets are reference-only (Copilot cannot execute them).' : '';
        const lossy = `copilot is a lossy target: "${skill.id}" is emitted as an always-on instruction file ` +
