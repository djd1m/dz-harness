...
/**
 * `@dzhechkov/skills-edu-site list` — Show installed Edu Site components and their status.
 *
...
async function run(options) {
  ...
  if (!fileExists(manifestPath)) {
    warn('Edu Site skill pack is not installed in this directory.');
  ...
  // ── Header ─────────────────────────────────────────────────────────────
  console.log('');
  console.log(bold(`@dzhechkov/skills-edu-site v${manifest.version}`));
