...
/**
 * `@dzhechkov/skills-edu-site update` — Update an existing Edu Site skill pack installation.
 *
...
async function run(options) {
  ...
  info(`Bundled version (this CLI): ${bold(newVersion)}`);
  info(dim('update syncs against the templates bundled with the running CLI — no registry check. Use "npx @dzhechkov/skills-edu-site@latest update" for the newest release.'));
  console.log('');
