...
// Manifest
const MANIFEST_FILE = '.skills-presentation-storyteller.json';
...
// Components — Presentation Storyteller specific
const COMPONENTS = {
  skill_presentation: {
    src: '.claude/skills/presentation-storyteller',
    label: 'Presentation Storyteller Skill (orchestrator)',
    group: 'core',
  },
  skill_explore: {
  ...
  commands: {
    src: '.claude/commands',
    label: 'Presentation Storyteller Command (1 command)',
    group: 'core',
    filter: 'presentation-storyteller',
  },
};
