 ...
 */
export function resolveEmbedSocketPath(projectRoot: string, env: NodeJS.ProcessEnv = process.env): ResolvedEmbedSocketPath {
...
export function embedSocketPointerPath(projectRoot: string): string {
 ...
 */
export function readEmbedSocketPointer(projectRoot: string): string | undefined {
 ...
 */
export function resolveEffectiveEmbedSocketPath(projectRoot: string, env: NodeJS.ProcessEnv = process.env): ResolvedEmbedSocketPath {
