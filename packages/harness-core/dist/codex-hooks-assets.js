...
function preamble(installedDistDir) {
 ...
 */
export function generateCodexVetoHelper(installedDistDir = harnessCoreDistDir()) {
 ...
 */
export function generateCodexRecallHelper(installedDistDir = harnessCoreDistDir()) {
 ...
 */
export function generateCodexHelpers(installedDistDir = harnessCoreDistDir()) {
    return {
