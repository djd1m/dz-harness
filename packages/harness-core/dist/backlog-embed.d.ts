 ...
 */
export declare const DEDUP_EMBED_FORM_VERSION = 2;
/**
 ...
 */
export declare const DEDUP_EMBED_CAP = 400;
/**
 ...
 */
export declare function dedupExcerpt(text: string): string;
/** The ONE dedup embed form (v2) — used by the query, the mirror write, and the reindex write. */
export declare function dedupEmbedText(text: string): string;
/**
 ...
 */
export declare function lexicalContainment(a: string, b: string): number;
 ...
 */
export declare function dedupPairBand(cosine: number, containment: number | undefined, cfg: DedupBandConfig): DedupPairBand;
//# sourceMappingURL=backlog-embed.d.ts.map