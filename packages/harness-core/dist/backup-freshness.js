...
export function decideBackupFreshness(input) {
    ...
    for (const line of input.lines) {
        ...
        if (!isSuccess) {
            ...
            if (line.trim() === '' || /^backup-backlog(?: \[[^\]]+\])?: отправлено,/.test(line) || /^\s*разобрано задач:/.test(line))
                continue;
            if (successLine !== '') {
                last = 'unrecognized';
...
export function renderBackupFreshness(verdict) {
...
//# sourceMappingURL=backup-freshness.js.map