 ...
 */
export declare function globalStoreRoot(home?: string): string;
/**
 ...
 */
export declare function sameStore(projectRoot: string, globalRoot: string): boolean;
/**
 ...
 */
export declare function mergeStoreHits<T>(projectRecords: readonly T[], globalRecords: readonly T[], key: (r: T) => string): (T & OriginTagged)[];
/** How the header should describe what was read — "1 store" is a fact worth stating, not assuming. */
export declare function storeCountLabel(count: number): string;
//# sourceMappingURL=store-merge.d.ts.map