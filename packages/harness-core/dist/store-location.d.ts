 ...
 */
export declare function describeStoreLocation(resolvedRoot: string, projectOption: string | undefined, 
/**
 ...
 */
origin?: StoreOrigin): StoreLocation;
/**
 ...
 */
export declare function storeLocationLine(loc: StoreLocation, verb: 'written' | 'read'): string;
