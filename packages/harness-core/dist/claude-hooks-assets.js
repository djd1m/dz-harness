...
export function isDzManagedHookBody(body) {
 ...
 */
export const CLAUDE_DESTRUCTIVE_HOOK_COMMAND = 'node "${CLAUDE_PROJECT_DIR}/' + CLAUDE_DESTRUCTIVE_HOOK_RELPATH + '"';
...
//# sourceMappingURL=claude-hooks-assets.js.map