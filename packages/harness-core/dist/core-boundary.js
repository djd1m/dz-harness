...
export function findProcessAccessInCode(source) {
...
export function countIoImports(source, modules = ['node:fs', 'fs', 'node:child_process', 'child_process', 'node:https', 'https']) {
    const file = ts.createSourceFile('boundary.ts', source, ts.ScriptTarget.Latest, true);
    let imports = 0;
    function visit(node) {
        let specifier;
...
//# sourceMappingURL=core-boundary.js.map